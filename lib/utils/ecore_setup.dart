...
class EcoreSetup {
  ...
  static const double USER_LOCATION_LAT = 28.6139; // New Delhi, India
  static const double USER_LOCATION_LNG = 77.2090;

  static const double NEARBY_LOCATION_LAT = 28.6149;
  static const double NEARBY_LOCATION_LNG = 77.2100;
